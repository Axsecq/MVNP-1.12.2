...
public class MVNPEntityListener implements Listener {
    ...
    protected boolean shootPlayer(Player p, Block block, PortalType type) {
        ...
        if (type == PortalType.ENDER) {
            ...
            if (block.getRelative(BlockFace.WEST).getType() == Material.PORTAL || block.getRelative(BlockFace.EAST).getType() == Material.PORTAL) {
    ...
    public void onEntityPortalEnter(EntityPortalEnterEvent event) {
        ...
        if (currentLocation.getBlock().getType() == Material.ENDER_PORTAL) {
            type = PortalType.ENDER;
        } else if (currentLocation.getBlock().getType() == Material.PORTAL) {
